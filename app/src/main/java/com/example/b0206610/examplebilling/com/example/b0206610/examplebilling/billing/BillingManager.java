...
public class BillingManager implements PurchasesUpdatedListener {
    ...
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "PUT_B64_APP_KEY_HERE";
    ...
    public void onPurchasesUpdated(int resultCode, List<Purchase> purchases) {
        Log.d("CUSTOM","Result code : "+String.valueOf(resultCode));
        Log.d("CUSTOM", "ACTUAL : "+ String.valueOf(BillingClient.BillingResponse.OK));
        if (purchases != null){
            for (Purchase p : purchases){
                Log.d("CUSTOM", p.getSku());
            }
        }
